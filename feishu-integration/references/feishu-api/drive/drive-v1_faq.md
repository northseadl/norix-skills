> API: https://open.feishu.cn/document/server-docs/docs/drive-v1/faq

# 云空间常见问题
[1. 如何获取文件夹、文件以及各种类型的云文档的 token 信息？](https://open.feishu.cn/document/server-docs/docs/drive-v1/faq#98ab04bb "1. 如何获取文件夹、文件以及各种类型的云文档的 token 信息？")
[2. 如何为应用身份（tenant_access_token）开通个人云空间中文件夹的查看或编辑权限？](https://open.feishu.cn/document/server-docs/docs/drive-v1/faq#b02e5bfb "2. 如何为应用身份（tenant_access_token）开通个人云空间中文件夹的查看或编辑权限？")
[3. 如何为应用身份（tenant_access_token）开通文件、素材的下载权限?](https://open.feishu.cn/document/server-docs/docs/drive-v1/faq#7773e647 "3. 如何为应用身份（tenant_access_token）开通文件、素材的下载权限?")
[4. 云文档支持一次性将文件夹、子文件夹、和子文件夹中的文件同时上传至云盘吗？](https://open.feishu.cn/document/server-docs/docs/drive-v1/faq#f394772a "4.  云文档支持一次性将文件夹、子文件夹、和子文件夹中的文件同时上传至云盘吗？")
[5. 云文档是否支持批量指定文档的所有者？](https://open.feishu.cn/document/server-docs/docs/drive-v1/faq#3626413c "5. 云文档是否支持批量指定文档的所有者？")
...
### 素材 token 获取方式
飞书开放平台支持在在线文档、电子表格、多维表格中上传和下载素材。在不同的云文档中，素材 token 的获取方式不同。具体方式如下所示： | 素材所在文档类型 | 素材 token 获取方式  
---|---  
...
要分享文件、素材的下载权限给应用，参考以下步骤：
  ...
  2. 在应用管理页面，点击**添加应用能力** ，找到机器人卡片，点击 **+添加** 。
  3. 根据分享的文件是否位于文件夹中，选择不同的开通权限方式：
     * 如果文件或素材不在文件夹中： **文档所有者、知识库管理员 或 其他协作者** 将应用添加为文档协作者。
     * 如果文件或素材位于**文件夹中：**
