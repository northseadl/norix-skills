> API: https://open.feishu.cn/document/server-docs/docs/wiki-v2/space-node/list
...
### 路径参数  
space_id | string |  [知识空间id](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-overview)，如果查询**我的文档库** 可替换为`my_library` **示例值** ："6946843325487906839"  
### 查询参数  
page_size | int |  分页大小 **示例值** ：10 **数据校验规则** ：
  * 最大值：`50`
...
parent_node_token | string |  父节点token **示例值** ："wikcnKQ1k3p******8Vabce"  
### 请求示例
以下为固定的代码示例。如需根据实际场景调整请求参数，可打开 APl 调试台 输入参数后生成相应的示例代码 操作指引
curl-i-XGET'https://open.
feishu.cn/open-apis/wiki/v2/
spaces/6946843325487906839/nodes?
page_size=10&
page_token=6946843325487456878&
parent_node_token=wikcnKQ1k3p%2A%
2A%2A%2A%2A%2A8Vabce' \
