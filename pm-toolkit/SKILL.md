...
version: 0.0.2
description: |
  产品经理工具包：将自然语言描述转换为 Mermaid 图表并在本地 Web 面板实时预览。
  支持 16 种图表（流程图/时序图/ER图/类图/状态机/甘特图/思维导图/C4架构图等）。
  面板功能：刷新/内联编辑+保存/SVG-PNG导出/源码复制/明暗主题。
  同时支持网页原型设计（wireframe/mockup/prototype）。
  Triggers: "画图", "流程图", "时序图", "架构图", "Mermaid", "原型", "wireframe".
---
