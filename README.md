...
| **[Coding.net 集成](https://skills.norix-dev.com/skills/coding-net)** | 0.0.1 | 🚧 DEV | Coding.net DevOps 平台 — MR/CI/制品库自动化。 |
| **[Skill Creator](https://skills.norix-dev.com/skills/skill-creator)** | — | 🔧 Meta | 技能创建、评估与描述优化工具链。 |
...
├── codex-task-orchestration/  # Agent 任务编排 — Codex / Claude Code 混合调度
